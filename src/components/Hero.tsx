...
import { ArrowDown } from "lucide-react";
import { Button } from "./ui/button";
import HeroSpline from "./HeroSpline"; // Load immediately (no lazy import)
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-4xl text-center px-6 space-y-6 sm:space-y-8">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold text-gradient whitespace-nowrap">
          Asterios&nbsp;Koutoulidis
        </h1>
