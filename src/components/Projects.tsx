    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <motion.h2
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
          className="p-4 text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-4 sm:mb-5 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-300"
        >
          Featured Projects
        </motion.h2>
        <motion.p
          ...
          className="p-4 text-center text-muted-foreground max-w-2xl mx-auto mb-12 sm:mb-14 text-sm sm:text-base"
        >
          Bellow are some of my recent projects showcasing my skills in
